...
export function CommunityJoinBanner({ variant = 'full', className = '' }: CommunityJoinBannerProps) {
  ...
  return (
    <section
      ...
      className={`relative w-full min-w-0 overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 p-6 sm:p-8 text-white shadow-2xl ${className}`}
    >
      ...
      <div className="pointer-events-none absolute -left-16 -top-20 h-56 w-56 rounded-full bg-emerald-600/20 blur-3xl" />
      <div className="pointer-events-none absolute -right-16 -bottom-20 h-56 w-56 rounded-full bg-sky-600/20 blur-3xl" />

      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
        {/* Left Column: Headline & Active Proposition */}
        <div className="lg:col-span-7 space-y-4 text-center lg:text-left">
          {/* Active Broadcast Status Header */}
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-950/60 px-3.5 py-1 text-xs font-bold text-emerald-300 backdrop-blur-md shadow-inner">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-emerald-400" />
            </span>
            <span className="tracking-wide uppercase text-[11px]">Live Newsroom Broadcast</span>
            <span className="text-slate-500">•</span>
            <span className="text-slate-300 font-semibold text-[11px]">48,500+ Active Readers</span>
          </div>
          ...
          {/* Value Triggers */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-y-2 gap-x-5 pt-1 text-xs font-medium text-slate-300">
        ...
        <div className="lg:col-span-5 flex flex-col sm:flex-row lg:flex-col gap-3.5 justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex items-center justify-between overflow-hidden rounded-2xl border border-emerald-500/40 bg-gradient-to-r from-slate-900 via-slate-900 to-emerald-950/40 p-4 transition-all duration-300 hover:border-emerald-400 hover:bg-slate-800/90 hover:shadow-xl hover:shadow-emerald-950/50 active:scale-[0.98]"
          >
            <div className="flex items-center gap-3.5">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-950 group-hover:scale-105 transition-transform">
              ...
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  <span className="text-sm font-bold text-white group-hover:text-emerald-300 transition-colors">Join WhatsApp Channel</span>
                  <span className="rounded-md bg-emerald-500/20 px-1.5 py-0.5 text-[10px] font-semibold text-emerald-300">Instant</span>
                </div>
                <div className="text-xs text-slate-400">1-Tap Follow • 29.4k Subscribers</div>
              </div>
            </div>
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-emerald-600/20 text-emerald-400 group-hover:bg-emerald-600 group-hover:text-white transition-all">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex items-center justify-between overflow-hidden rounded-2xl border border-sky-500/40 bg-gradient-to-r from-slate-900 via-slate-900 to-sky-950/40 p-4 transition-all duration-300 hover:border-sky-400 hover:bg-slate-800/90 hover:shadow-xl hover:shadow-sky-950/50 active:scale-[0.98]"
          >
            <div className="flex items-center gap-3.5">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-sky-500 to-blue-600 text-white shadow-lg shadow-sky-950 group-hover:scale-105 transition-transform">
                <Send className="h-6 w-6 ml-0.5" />
              </div>
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  <span className="text-sm font-bold text-white group-hover:text-sky-300 transition-colors">Join Telegram Channel</span>
                  <span className="rounded-md bg-sky-500/20 px-1.5 py-0.5 text-[10px] font-semibold text-sky-300">VIP</span>
                </div>
                <div className="text-xs text-slate-400">Global Alerts • 19.1k Subscribers</div>
              </div>
            </div>
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-sky-600/20 text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-all">
              <ArrowUpRight className="h-5 w-5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
            </div>
          </a>
        </div>
