  ...
  return (
    <>
      <header
        ...
        className="pd-site-header sticky top-0 z-40 max-w-[100vw] overflow-visible border-b border-slate-800/80 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 shadow-lg shadow-slate-900/30"
      >
        <div suppressHydrationWarning className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 2xl:max-w-[1440px]">
          <div suppressHydrationWarning className="flex h-14 items-center justify-between gap-2.5 sm:gap-3 sm:h-16">
            ...
            <div suppressHydrationWarning className="flex min-w-0 items-center justify-end gap-1.5 sm:gap-2.5">
              <LocalConditions />

              <nav suppressHydrationWarning className="flex items-center gap-1.5 sm:gap-2" aria-label="Primary">
                <Link
                  href="/quiz"
                ...
                >
                  ...
                  <span suppressHydrationWarning className="hidden sm:flex items-center gap-0.5 rounded bg-slate-800 px-1.5 py-0.5 text-[10px] font-mono text-slate-400 border border-slate-700">
          ...
          <div suppressHydrationWarning className="border-t border-white/10 py-2.5">
            <CategoryNav />
          </div>
        </div>
      </header>
