...
const PLACEHOLDER_WASH: Record<string, string> = {
  ...
  World: 'from-sky-950 via-slate-950 to-cyan-900/70',
  ...
  Economy: 'from-cyan-950 via-slate-950 to-teal-900/70',
  ...
  Technology: 'from-blue-950 via-slate-950 to-indigo-900/70',
  Tech: 'from-blue-950 via-slate-950 to-indigo-900/70',
  Science: 'from-cyan-950 via-slate-950 to-blue-900/70',
  Health: 'from-emerald-950 via-slate-950 to-teal-900/70',
...
const ACCENT_ORB: Record<string, string> = {
  ...
  Economy: 'bg-cyan-400/25',
  Politics: 'bg-indigo-400/25',
  'Stocks & Markets': 'bg-emerald-400/25',
  Crypto: 'bg-orange-400/25',
  Technology: 'bg-blue-400/25',
  Tech: 'bg-blue-400/25',
  Science: 'bg-cyan-400/25',
  Health: 'bg-emerald-400/25',
