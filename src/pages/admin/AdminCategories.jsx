    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-1">{categories.length} categories total</p>
        </div>
            ...
            <Card key={category.id} className="p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="flex gap-2 mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                ...
                <Button
                  ...
                  className="text-red-600 border-red-300 hover:bg-red-50 dark:text-red-400 dark:border-red-800"
                >
