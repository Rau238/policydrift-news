  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Tags Management</h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">{tags.length} tags total</p>
        </div>
              ...
              <Card key={tag._id} className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400 mt-1">{new Date(tag.created_at).toLocaleDateString()}</p>
                  </div>
