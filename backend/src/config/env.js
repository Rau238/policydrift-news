...
export const env = {
  ...
  RSS_POLL_INTERVAL: parseInt(process.env.RSS_POLL_INTERVAL || '60000', 10) || 60000,
  RSS_REQUEST_TIMEOUT: parseInt(process.env.RSS_REQUEST_TIMEOUT || '15000', 10) || 15000,
  RSS_MAX_RETRIES: parseInt(process.env.RSS_MAX_RETRIES || '3', 10) || 3,
  RSS_EXTRACT_FULL_ARTICLE: process.env.RSS_EXTRACT_FULL_ARTICLE !== 'false',
  RSS_CRON_INTERVAL_MINUTES: Math.min(
    59,
    Math.max(1, parseInt(process.env.RSS_CRON_INTERVAL_MINUTES || '1', 10) || 1),
  ),
